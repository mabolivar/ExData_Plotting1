...
png(filename = "./figure/plot4.png",width = 480, height = 480, units="px",bg = "transparent")
par(mfrow=c(2,2))
#Plot 1,1
plot(epc$Time,epc$Global_active_power,type = "l", xlab="",ylab="Global Active Power (kilowatts)",lwd=0.01)

#Plot 1,2
with(epc,plot(Time,Voltage,type = "l", xlab="Time",ylab="datetime"),lwd=0.01)
...
legend("topright",legend = paste(rep("Sub_metering_",3),1:3,sep=""),
       lty=1,col = c("black","red","blue"),bty="n")

#Plot 2,2
with(epc,plot(Time,Global_reactive_power,type = "l", xlab="datetime"),lwd=0.01)
